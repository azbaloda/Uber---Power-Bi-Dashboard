...
A measure selector will be created for: <br>
✔ Total Bookings <br>
...
Features of the Grid Tab:<br>
1. Grid Table with Key Fields:<br>
•	Displays essential trip details<br>
2. Drill-Through Functionality:<br>
•	Users can right-click on a data point from other visuals (e.g., charts, heatmaps) and drill through to this Grid Tab. <br>
•	Displays detailed records related to the selected data point. <br>
3. Bookmark for Full Data View:<br>
